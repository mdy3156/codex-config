...
Preserve the source's meaning and evidence. Do not add facts, names, numbers, examples, mechanisms, or citations that are absent from the source and were not supplied by the user.
